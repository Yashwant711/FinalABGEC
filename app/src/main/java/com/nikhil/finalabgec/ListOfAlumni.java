...
import com.nikhil.finalabgec.Adapter.AlumniListAdapter;
...
public class ListOfAlumni extends AppCompatActivity {
    ...
    AlumniListAdapter list_adapter;
    TextView loadText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list_adapter = new AlumniListAdapter(ListOfAlumni.this,list);
    ...
    private void search (String s) {
        ...
        AlumniListAdapter userAdapter = new AlumniListAdapter(ListOfAlumni.this, mylist);
